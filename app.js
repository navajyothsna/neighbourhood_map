...
var Model = {
  ...
  markers: [
    {
      title: 'Marina Square Singapore',
      lat: 1.291499,
      lng: 103.857825,
      url: 'https://www.marinasquare.com.sg',
    ...
    },
    {
      ...
      lat: 1.404348,
      lng: 103.793023,
      url: 'https://www.wrs.com.sg/en/singapore-zoo',
      highlight: ko.observable(false)
    },
    {
    ...
    {
      title: 'Mustafa Shopping Mall Singapore ',
      lat: 1.309607,
      lng: 103.855856,
    ...
    },
    {
      ...
      lat: 1.280528,
      lng: 103.871175,
      url: 'https://www.pub.gov.sg/marinabarrage',
      highlight: ko.observable(false)
    },
    {
      title: 'Botanical Garden singapore',
      lat: 1.313840,
      lng: 103.8159147,
      url: 'https://www.nparks.gov.sg/.../singapore-botanic-gardens',
      highlight: ko.observable(false)
    },
...
var ViewModel = function() {
    ...
    if(typeof window.google === 'object' && typeof window.google.maps === 'object') {
      ...
      for(var x = 0; x < markerList.length; x++) {
        ...
        google.maps.event.addListener(marker, 'click', function() {
          var that = this; animateUponClick(this);
  ...
  //animate the marker to bounce upon a click.
